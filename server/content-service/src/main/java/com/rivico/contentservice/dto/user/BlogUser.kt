package com.rivico.contentservice.dto.user

import com.rivico.contentservice.authority.BlogUserAuthority
...
data class BlogUser(
    ...
    val blogAuthorities: Set<com.rivico.contentservice.authority.BlogUserAuthority>
)